      ...
      <Carousel activeItem={1} length={4} showControls={true} showIndicators={true} className="z-depth-1">
        <CarouselInner>
          <CarouselItem itemId="1">
            <View>
              <img className="d-block w-100" src="https://cdn.vox-cdn.com/thumbor/TLqyzbKPuzHMFzfeXDkEjvbLdoE=/0x0:4200x2363/1200x800/filters:focal(1764x846:2436x1518)/cdn.vox-cdn.com/uploads/chorus_image/image/59463197/GettyImages-116486193.0.jpg" alt="First slide" />
